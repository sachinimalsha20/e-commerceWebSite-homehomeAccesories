...
$SQL="select prodId, prodName, prodPicNameLarge, prodDescriptionLong, prodPrice, prodQuantity from product where prodId=$prodid";
...
while($arrayp=mysqli_fetch_array($exeSQL))
{
	...
	echo "<p>".$arrayp['prodDescriptionLong']."</p>"; //display product description short
